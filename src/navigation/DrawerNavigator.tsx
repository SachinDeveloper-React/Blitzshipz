...
//         options={({route}) => ({
//           headerShown: true,
//           headerTitle: 'Print Label',
//           drawerLabel: 'Print Label',
//           drawerIcon: ({focused, size}) => (
//             <Image
//               source={require('../assets/icons/createOrder.png')}
//               style={{
  ...
  return (
    <Drawer.Navigator
      ...
      <Drawer.Screen
        name="BookmyOrderScreen"
        component={BookmyOrderScreen}
        options={{headerTitle: 'Book My Order'}}
      />
      <Drawer.Screen
        name="PrintLabelScreen"
        component={PrintLabelScreen}
        options={{headerTitle: 'Print Label'}}
      />
      <Drawer.Screen
        name="CodScreen"
        component={CodScreen}
        options={{headerTitle: 'COD'}}
      />
      <Drawer.Screen
        name="WeightDiscrepancyScreen"
        component={WeightDiscrepancyScreen}
        options={{headerTitle: 'Weight Discrepancy'}}
      />
      <Drawer.Screen
        name="RateCalculatorScreen"
        component={RateCalculatorScreen}
        options={{headerTitle: 'Rate Calculator'}}
      />
      <Drawer.Screen
        name="FaqScreen"
        component={FaqScreen}
