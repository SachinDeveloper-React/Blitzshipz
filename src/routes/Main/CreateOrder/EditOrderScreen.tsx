...
const EditOrderScreen = ({
  ...
  const [value1, setValue1] = useState(state.warehouseName);
  ...
  useEffect(() => {
    setValue1(state?.warehouseName); // use warehouse ID instead of name
  }, [state.warehouseName, warehouses]);

  useEffect(() => {
    setValue1(state.sellerName); // use warehouse ID instead of name
  }, [state.sellerName, sellers]);
        ...
        <KeyboardAwareScrollView
          ...
          <View style={{marginTop: 30}}>
            ...
            <TextInput
              ...
              defaultValue={state.sellerAddress}
              onChangeText={text => {
